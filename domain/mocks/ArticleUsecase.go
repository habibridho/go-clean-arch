...
func (_m *ArticleUsecase) Fetch(ctx context.Context, cursor string, num int64) ([]article.Article, string, error) {
...
func (_m *ArticleUsecase) GetByID(ctx context.Context, id int64) (article.Article, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ArticleUsecase) GetByTitle(ctx context.Context, title string) (article.Article, error) {
...
func (_m *ArticleUsecase) Store(_a0 context.Context, _a1 *article.Article) error {
...
func (_m *ArticleUsecase) Update(ctx context.Context, ar *article.Article) error {
