...
func (_m *ArticleRepository) Fetch(ctx context.Context, cursor string, num int64) ([]article.Article, string, error) {
	ret := _m.Called(ctx, cursor, num)

	var r0 []article.Article
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) []article.Article); ok {
...
func (_m *ArticleRepository) GetByID(ctx context.Context, id int64) (article.Article, error) {
	ret := _m.Called(ctx, id)
...
func (_m *ArticleRepository) GetByTitle(ctx context.Context, title string) (article.Article, error) {
...
func (_m *ArticleRepository) Store(_a0 context.Context, _a1 *article.Article) error {
...
func (_m *ArticleRepository) Update(ctx context.Context, ar *article.Article) error {
